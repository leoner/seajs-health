...
(function(win, doc) {
  ...
  seajs.use(['http://localhost:8000/bookmarklet/d3.v3.min.js',
            'http://localhost:8000/src/seajs-health',
            'http://localhost:8000/bookmarklet/app.js',
            'http://localhost:8000/bookmarklet/d3.css'], function(d3, health, app) {
